            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                ...
                <div>
                    ...
                    <textarea name="description" rows="2"
                        class="w-full border border-stone-200 p-2.5 rounded-xl outline-none focus:border-[#b5122b]">{{ old('description', $product->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description_ar" dir="rtl" rows="2"
                        class="w-full border border-stone-200 p-2.5 rounded-xl outline-none focus:border-[#b5122b]">{{ old('description_ar', $product->description_ar) }}</textarea>
                </div>
            </div>
        </div>
